...
DPT.objects.processDirs(dirs=None, objtype=pyh.RPLSplit, channel=[*range(97,135)]); \
...
aws sns publish --topic-arn arn:aws:sns:ap-southeast-1:976193226829:awsnotify --message "RS4JobDone"
